...
/**
 * This method is copied and modified from ImageJ
 * https://github.com/fiji/Auto_Threshold/blob/master/src/main/java/fiji/threshold/Auto_Threshold.java
 * It is a collection of threshold estimation methods implemented by multiple people listed below
 * 
...
public class ThresholdingMethods  {

	public String [] methods={"IJDefault", "Huang", "Huang2", "Intermodes", "IsoData",  "Li", "MaxEntropy","Mean", "MinErrorI", "Minimum", "Moments", "Otsu", "Percentile", "RenyiEntropy", "Shanbhag" , "Triangle", "Yen"};
